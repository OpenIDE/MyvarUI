...
namespace MyvarUI
{
    internal static class KnownColors
    {
        internal enum GetSysColorIndex
        {
            ...
            ColorMaxvalue = 30, /* Maximum value */
        }
        ...
        {
            uint bgr = WindowsSdlWrapper.GetSysColor((int) index);
            return 0xFF000000 | (bgr & 0xFF) << 16 | (bgr & 0xFF00) | (bgr >> 16);
        }

        static void RetrieveWindowsSystemColors()
        {
            ArgbValues[(int) KnownColor.ActiveBorder] = GetSysColor(GetSysColorIndex.ColorActiveborder);
            ArgbValues[(int) KnownColor.ActiveCaption] = GetSysColor(GetSysColorIndex.ColorActivecaption);
            ArgbValues[(int) KnownColor.ActiveCaptionText] = GetSysColor(GetSysColorIndex.ColorCaptiontext);
            ArgbValues[(int) KnownColor.AppWorkspace] = GetSysColor(GetSysColorIndex.ColorAppworkspace);
            ArgbValues[(int) KnownColor.Control] = GetSysColor(GetSysColorIndex.ColorBtnface);
            ArgbValues[(int) KnownColor.ControlDark] = GetSysColor(GetSysColorIndex.ColorBtnshadow);
            ...
            ArgbValues[(int) KnownColor.ControlLightLight] = GetSysColor(GetSysColorIndex.ColorBtnhighlight);
            ArgbValues[(int) KnownColor.ControlText] = GetSysColor(GetSysColorIndex.ColorBtntext);
            ArgbValues[(int) KnownColor.Desktop] = GetSysColor(GetSysColorIndex.ColorDesktop);
            ArgbValues[(int) KnownColor.GrayText] = GetSysColor(GetSysColorIndex.ColorGraytext);
            ArgbValues[(int) KnownColor.Highlight] = GetSysColor(GetSysColorIndex.ColorHighlight);
            ArgbValues[(int) KnownColor.HighlightText] = GetSysColor(GetSysColorIndex.ColorHighlighttext);
            ArgbValues[(int) KnownColor.HotTrack] = GetSysColor(GetSysColorIndex.ColorHotlight);
            ArgbValues[(int) KnownColor.InactiveBorder] = GetSysColor(GetSysColorIndex.ColorInactiveborder);
            ArgbValues[(int) KnownColor.InactiveCaption] = GetSysColor(GetSysColorIndex.ColorInactivecaption);
            ArgbValues[(int) KnownColor.InactiveCaptionText] = GetSysColor(GetSysColorIndex.ColorInactivecaptiontext);
            ArgbValues[(int) KnownColor.Info] = GetSysColor(GetSysColorIndex.ColorInfobk);
            ArgbValues[(int) KnownColor.InfoText] = GetSysColor(GetSysColorIndex.ColorInfotext);
            ArgbValues[(int) KnownColor.Menu] = GetSysColor(GetSysColorIndex.ColorMenu);
            ArgbValues[(int) KnownColor.MenuText] = GetSysColor(GetSysColorIndex.ColorMenutext);
            ArgbValues[(int) KnownColor.ScrollBar] = GetSysColor(GetSysColorIndex.ColorScrollbar);
            ArgbValues[(int) KnownColor.Window] = GetSysColor(GetSysColorIndex.ColorWindow);
            ArgbValues[(int) KnownColor.WindowFrame] = GetSysColor(GetSysColorIndex.ColorWindowframe);
            ArgbValues[(int) KnownColor.WindowText] = GetSysColor(GetSysColorIndex.ColorWindowtext);
            ArgbValues[(int) KnownColor.ButtonFace] = GetSysColor(GetSysColorIndex.ColorBtnface);
            ArgbValues[(int) KnownColor.ButtonHighlight] = GetSysColor(GetSysColorIndex.ColorBtnhighlight);
            ArgbValues[(int) KnownColor.ButtonShadow] = GetSysColor(GetSysColorIndex.ColorBtnshadow);
            ArgbValues[(int) KnownColor.GradientActiveCaption] =
                GetSysColor(GetSysColorIndex.ColorGradientactivecaption);
            ArgbValues[(int) KnownColor.GradientInactiveCaption] =
                GetSysColor(GetSysColorIndex.ColorGradientinactivecaption);
            ArgbValues[(int) KnownColor.MenuBar] = GetSysColor(GetSysColorIndex.ColorMenubar);
            ArgbValues[(int) KnownColor.MenuHighlight] = GetSysColor(GetSysColorIndex.ColorMenuhighlight);
        }
        ...
        public static Color FindColorMatch(Color c)
        {
            ...
            for (int i = firstRealColorIndex - 1; i < lastRealColorIndex; i++)
            {
